...
NAME = _util.get_fn(__file__)
out_dir = _config.OUT_PLACE + NAME + '/'
_util.ensure_dir_exists(out_dir)
log_fn = None
...
def parse_custom_hyperparams(custom_hyperparams):
  ...
  for term in custom_hyperparams.split('+'):
    ...
    if kw in ['learning_rate', 'plateau_patience', 'plateau_threshold', 'dropout_p', 'training_fraction']:
...
def load_data(dataset_id, train_test_id):
  ...
  if 'CSNVL' not in dataset_id:
    ...
    package = generate_train_test_CSNVL(X, Y, NAMES, dataset_id, train_test_id)
...
def generate_train_test_CSNVL(X, Y, NAMES, dataset_id, train_test_id, valid_frac = 0.10):

  all_idxs = list(range(len(NAMES)))
  np.random.shuffle(all_idxs)
  n = len(all_idxs)
  tt_split = n - 1
  train_idxs = all_idxs[:tt_split]
  test_idxs = all_idxs[tt_split:]
...
def gen_qsubs():
  ...
  exp_nms = [
    ...
    # 'U2OS_12kChar_AID',
    # 'U2OS_12kChar_BE4',
    # 'U2OS_12kChar_BE4-CP1028',
    # 'U2OS_12kChar_CDA',
    # 'U2OS_12kChar_eA3A',
    # 'U2OS_12kChar_evoAPOBEC',
    # 'HEK293T_12kChar_eA3A_noUGI',
    # 'HEK293T_12kChar_eA3A_noUGI_T31A',
    # 'HEK293T_12kChar_eA3A_Nprime_UGId12_T30A',
    # 'HEK293T_12kChar_eA3Amax_T44DS45A',
    # 'HEK293T_12kChar_BE4max_H47ES48A',
    # 'mES_12kChar_eA3A_T31A',
    # 'mES_12kChar_eA3A_T31AT44A',
    # 'mES_12kChar_BE4_H47ES48A',
    # 'HEK293T_12kChar_eA3A_Nprime_UGId12_T30A',
    # 'HEK293T_12kChar_eA3A_noUGI',
    # 'HEK293T_12kChar_eA3A_noUGI_T31A',
    # 'mES_12kChar_689_noUGI',
    # 'mES_12kChar_APOBEC1_noUGI',
    # 'mES_12kChar_eA3A_noUGI_T31A_dead',
    # 'mES_12kChar_eA3A_noUGI_dead',
    # 'mES_12kChar_ee_noUGI',
    # 'mES_12kChar_D2_APOBEC1_UDGX_UDGX',
    # 'mES_12kChar_Rb_eA3A_UDGX',
    # 'mES_12kChar_Rb_eA3A_UDGX_HF',
    # 'mES_12kChar_UDGX_689_UDGX_Rb',
    # 'mES_12kChar_UDGX_APOBEC1_UDGX_HF',
    # 'mES_12kChar_UDGX_ee_UDGX_UDGX',
    'mES_CSNVL_AID',
    'mES_CSNVL_BE4-CP1028',
    'mES_CSNVL_BE4',
    'mES_CSNVL_CDA',
    'mES_CSNVL_eA3A',
    'mES_CSNVL_evoAPOBEC',
  ...
  hyperparam_combinations = {
    ...
    # Lower N
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.10': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.10',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.20': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.20',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.30': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.30',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.40': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.40',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.50': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.50',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.60': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.60',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.70': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.70',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.80': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.80',
    # 'enc_64x2_dec_256x2_nc_r5_nopos_d0.05_frac0.90': 'encoder_hidden_sizes:64,64+decoder_hidden_sizes:256,256+context_feature:1+fullcontext_feature:0+position_feature:0+context_radii:5+dropout_p:0.05+training_fraction:0.90',
  ...
  for exp_nm in exp_nms:
    for train_test_id in range(1):
      for hyperparam_nm in hyperparam_combinations:
        ...
        # Write qsub commands
        qsub_commands.append('qsub -V -P regevlab -l h_rt=16:00:00,h_vmem=8G -l os=RedHat7 -wd %s %s &' % (_config.SRC_DIR, sh_fn))
