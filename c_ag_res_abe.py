...
class BaseEditing_Dataset(Dataset):
  ...
  def form_masked_edit_vectors(self, editable_pos, pos_to_col, col_to_obs_edit):
    ...
    for pos in editable_pos:
      ...
      edit_vector_a = least_masked_edit_vector_a[:mask_idx] + mask
      edit_vector_c = least_masked_edit_vector_c[:mask_idx] + mask
      edit_vec = edit_vector_a + edit_vector_c 
...
def gen_qsubs():
  ...
  exp_nms = [
    ...
    # 'U2OS_12kChar_ABE',
    # 'U2OS_12kChar_ABE-CP1040',
    # 'mES_12kChar_ABE8',
    'mES_CSNVL_ABE-CP1040',
    'mES_CSNVL_ABE',
  ]
